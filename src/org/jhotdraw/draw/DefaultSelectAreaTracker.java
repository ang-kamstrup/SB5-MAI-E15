...
/**
 * <code>DefaultSelectAreaTracker</code> implements interactions with the
 * background area of a
 * <code>Drawing</code>. <p> The
 * <code>DefaultSelectAreaTracker</code> handles one of the three states of the
 * <code>SelectionTool</code>. It comes into action, when the user presses the
 * mouse button over the background of a
 * <code>Drawing</code>. <p> Design pattern:<br> Name: Chain of
 * Responsibility.<br> Role: Handler.<br> Partners: {@link SelectionTool} as
 * Handler, {@link DragTracker} as Handler, {@link HandleTracker} as Handler.
 * <p> Design pattern:<br> Name: State.<br> Role: State.<br> Partners:
 * {@link SelectionTool} as Context, {@link DragTracker} as State,
 * {@link HandleTracker} as State.
 *
 * @see SelectionTool
 *
 * @author Werner Randelshofer
 * @version 4.0 2008-05-17 Displays handles with index -1, if the mouse hovers
 * over a figure. <br>3.0 2006-02-15 Updated to handle multiple views. <br>1.0
 * 2003-12-01 Derived from JHotDraw 5.4b1.
 */

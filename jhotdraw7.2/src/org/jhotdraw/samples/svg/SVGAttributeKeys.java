 ...
 * @version 1.3 2007-12-16 Added TITLE and DESCRIPTION. <br>1.2 2007-04-22
 * Attribute Key LINK added. <br>1.1 2007-04-10 Attribute key TEXT_ALIGN added.
...
public class SVGAttributeKeys extends AttributeKeys {
    ...
    /**
     * Specifies the title of an SVG drawing. This attribute can be null, to
     * indicate that the drawing has no title.
     */
    public final static AttributeKey<String> TITLE = new AttributeKey<String>("title", String.class, null, true, labels);
    /**
     * Specifies the description of an SVG drawing. This attribute can be null,
     * to indicate that the drawing has no description.
     */
    public final static AttributeKey<String> DESCRIPTION = new AttributeKey<String>("description", String.class, null, true, labels);
    /**
     * Specifies the viewport-fill of an SVG viewport. This attribute can be
     * null, to indicate that the viewport has no viewport-fill.
     */
    ...
    /**
     * Specifies the fill opacity of a SVG figure. This is a value between 0 and
     * 1 whereas 0 is translucent and 1 is fully opaque.
     */
    public final static AttributeKey<Double> FILL_OPACITY = new AttributeKey<Double>("fillOpacity", Double.class, 1d, false, labels);
    /**
     * Specifies the overall opacity of a SVG figure. This is a value between 0
    ...
    /**
     * Specifies the stroke opacity of a SVG figure. This is a value between 0
     * and 1 whereas 0 is translucent and 1 is fully opaque.
     */
    ...
    /**
     * Specifies the shadow opacity of a SVG figure. This is a value between 0
     * and 1 whereas 0 is translucent and 1 is fully opaque.
     */
    //</editor-fold>
    public final static AttributeKey<Double> SHADOW_OPACITY = new AttributeKey<Double>("shadowOpacity", Double.class, 1d, false, labels);
    /**
     * Specifies a link. In an SVG file, the link is stored in a "a" element
    ...
    /**
     * Specifies a link target. In an SVG file, the link is stored in a "a"
     * element which encloses the figure.
     * http://www.w3.org/TR/SVGMobile12/linking.html#AElement
     */
     ...
     * STROKE_GRADIENT, STROKE_OPACITY, STROKE_PAINT and the bounds of the
     * figure. Returns null if the figure is not filled.
     */
    ...
    public static Paint getShadowPaint(Figure f) {

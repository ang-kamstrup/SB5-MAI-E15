 ...
 * @version 2.0 2008-04-06 Reworked. <br>1.0 May 1, 2007 Created.
 */
    ...
    protected JComponent createDisclosedComponent(int state) {
        ...
        switch (state) {
            case 1: {
                ...
                btn = ButtonFactory.addToolTo(this, editor, pathTool = new PathTool(new SVGPathFigure(), new SVGBezierFigure(true), attributes), "edit.insertGraph", labels);
                pathTool.setToolDoneAfterCreation(true);
                btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
                gbc = new GridBagConstraints();
                gbc.gridx = 3;
                gbc.gridy = 0;
